...
final public class Disposables {
	...
	/**
	 * Create a new empty {@link SequentialDisposable} with atomic guarantees on all mutative
	 * operations.
	 *
	 * @return an empty atomic {@link SequentialDisposable}
	 */
	public static SequentialDisposable sequentialDisposable() {
		return new AtomicSequentialDisposable();
	}

	/**
	 * Create a new empty {@link CompositeDisposable} with atomic guarantees on all mutative
	 * operations.
	 *
	 * @return an empty atomic {@link CompositeDisposable}
	 */
	public static CompositeDisposable<Disposable> compositeDisposable() {
		return new AtomicCompositeDisposable();
	}

	/**
	 * Create and initialize a new {@link CompositeDisposable} with atomic guarantees on
	 * all mutative operations.
	 *
	 * @return a pre-filled atomic {@link CompositeDisposable}
	 */
	public static CompositeDisposable<Disposable> compositeDisposable(Disposable... disposables) {
	 ...
	 * @return a pre-filled atomic {@link CompositeDisposable}
	 */
	public static CompositeDisposable<Disposable> compositeDisposable(Iterable<? extends Disposable> disposables) {
		return new AtomicCompositeDisposable(disposables);
	}
}